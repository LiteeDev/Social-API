...
namespace Social_Client
{
    class Utilities
    {
        ...
        public static string GetDisk(string diskLetter)
        {
            //Find first drive
        ...
        {
            var volumeSerial = Utilities.GetDisk("C");
            var cpuSerial = Utilities.GetCPU();
            var MoboSerial = Utilities.GetMobo();
            string concatString = volumeSerial + "_" + cpuSerial + "_" + MoboSerial;
            var encrypted = Utilities.CreateMD5(concatString);
            return encrypted;
        }
