...
Documenation for the Social API for Client & Desktop.
...
Anti-Debugger | We will need to insert functions to protect against Debugger Applications looking for break-points | :no_smoking:
Anti-VM | We will need to insert functions to protect against Virtual Machine Applications looking for break-points | :no_smoking:
